    ...
    <header className="bg-white border-b border-gray-200 shadow-sm">
      <div className="px-2 mx-auto max-w-7xl sm:px-4 lg:px-8">
        <div className="flex items-center justify-between py-4 sm:py-6 lg:justify-start lg:space-x-8">
          ...
          <div className="flex items-center ml-auto space-x-3 sm:space-x-4 lg:flex-1 lg:justify-end lg:ml-0 lg:gap-4 md:gap-2">
            ...
            <button
              onClick={logout}
              className="inline-flex items-center px-2 py-2 text-xs font-medium text-gray-700 transition-colors bg-white border border-gray-300 rounded-lg sm:px-3 sm:text-sm hover:bg-gray-200 focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
            >
